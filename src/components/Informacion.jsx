    ...
    <section>
      ...
      <ol className="list-group">
        <li className="list-group-item">
          Componemtes: Son bloques de construcción fundamentales en React.
        ...
        <li className="list-group-item">
          ...
          catualización y desmontaje. Esto permite realizar acciones específicas
        ...
        <li className="list-group-item">
          ...
          facilita la creación de elementos de interfaz de usuario React.
        </li>
      </ol>
    </section>
  );
